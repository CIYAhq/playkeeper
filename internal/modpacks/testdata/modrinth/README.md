...
| `projects.json` | `GET /projects?ids=[...]` for CSMP, Adrenaline, Vanilla Perfected, Create+ and Sodium Plus | `body` and `gallery` emptied; each project's `versions` list cut to at most 8 ids |
