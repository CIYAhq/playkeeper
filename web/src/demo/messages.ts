...
const en = {
  ...
  'demo.welcomeTitle': 'Playkeeper live demo',
  'demo.welcomeBody': 'A Minecraft server dashboard with sample servers. Click anything: nothing is real, and it all resets every hour.',
  'demo.welcomeStart': 'Start clicking',
  'demo.promptTitle': 'Like it so far?',
  'demo.promptClose': 'Close',
  'demo.star': 'Star on GitHub',
  'demo.repoUrl': 'https://github.com/CIYAhq/playkeeper',
  'demo.ask': 'Questions? Ask in GitHub Discussions',
  'demo.communityUrl': '/community',
