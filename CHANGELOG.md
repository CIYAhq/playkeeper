...
- Discord: paste a channel's webhook link for alerts (a crash, back online, low disk space, a failed backup, and more if you want them) and one live status message with each server and who's playing.
