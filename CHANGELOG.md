...
- More server types: Vanilla, Fabric, Quilt, NeoForge, Forge and Purpur alongside Paper, each downloaded from its project and checked against the checksum it publishes.
